...
define('DB_USER',   'root');
define('DB_PASS',   '');
define('DB_NAME',   'tokobungajakartautara');
define('DB_CHARSET','utf8mb4');

define('BASE_URL',  'http://localhost/TOKOBUNGAJAKARTAUTARA');
define('SITE_NAME', 'Toko Bunga Jakarta Utara');
...
function waLink(string $message = ''): string {
    ...
    $msg = urlencode($message ?: 'Halo, saya ingin memesan bunga dari Toko Bunga Jakarta Utara.');
